...
<head>
    ...
    <title>Connexion - DélicesApp</title>
    <!-- Bootstrap CSS -->
...
<div class="form-login shadow-sm">
    <img src="assets/img/logo.png" alt="Logo DélicesApp" class="logo-login" onerror="this.style.display='none'">
    ...
    <button type="submit" class="btn btn-pink w-100 mt-2">Se connecter</button>
    <div class="text-end mt-2">
        <a href="forgot_password.php" class="link-pink">Mot de passe oublié&nbsp;?</a>
    </div>
</form>

    <p class="text-center mt-3 mb-0">Pas encore de compte ? <a href="register.php" class="link-pink">S'inscrire</a></p>
</div>
