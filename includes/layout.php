...
<head>
  ...
  <style>
    ...
    .btn-pink { background-color: #f783ac; color: #fff; border: none; }
    .btn-pink:hover { background-color: #d63384; }
    .btn-outline-pink { border: 2px solid #f783ac; color: #f783ac; background: transparent; }
    .btn-outline-pink:hover { background-color: #d63384; color: white; }
    .navbar .dropdown-menu { min-width: 200px; }
    .dropdown-item:hover { background-color: #d63384; }
  </style>
</head>
  ...
  <header class="bg-light border-bottom mb-4">
    <div class="container d-flex flex-wrap justify-content-between align-items-center py-3">
      <a href="index.php" class="d-flex align-items-center mb-2 text-decoration-none">
        <img src="/assets/images/logo-delices.png" alt="Logo" style="width: 50px;" class="me-2">
      ...
      <nav class="d-flex align-items-center w-100">
        <ul class="nav me-auto">
          ...
          <li class="nav-item"><a href="panier.php" class="nav-link text-dark">Panier</a></li>
          <li class="nav-item"><a href="paiement.php" class="nav-link text-dark">Paiement</a></li>
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
          <?php
            ...
            $photo = !empty($_SESSION['photo']) ? $_SESSION['photo'] : 'default.png';
            // Vérifie si le fichier existe physiquement, sinon fallback sur default.png
          ...
          <div class="dropdown ms-3">
            <a class="d-flex align-items-center text-decoration-none dropdown-toggle" href="#" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="/uploads/<?= htmlspecialchars($photo) ?>"
                   alt="Photo de profil"
                   width="65" height="65"
                   class="rounded-circle me-2"
                   style="object-fit: cover; border:2px solid #f783ac;">
              <strong class="text-pink"><?= htmlspecialchars($_SESSION['username']) ?></strong>
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser1">
              <li><a class="dropdown-item" href="profil.php">Modifier mes informations</a></li>
